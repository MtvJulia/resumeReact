            ...
            <div id="langListUnit">              
                        ...
                        if (item.langName != null) {
                            return (
                                ...
                                <div>                                   
                                    ...
                                    <select className="form-control" id="id_langName" name="id_langName" defaultValue ={item.langName} ref={this.input} >
                ...
                <a id={"idDelete"} href="javascript:DeleteLang(e)" name = "delete" onClick={this.DeleteLang} > Удалить  </a>              
                    ...
                    <div className="row">
                        <div className="form-group col-12 col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <label for="id_langName">Язык:</label>
                               <select className="form-control" id="id_langName" name="id_langName" defaultValue ="" ref={this.input} >
                                <option value="" disabled selected hidden>Выберите язык</option>                               
                                <option value="1">Украинский</option>
                                <option value="2">Русский</option>
                                <option value="3">Английский</option>
