            ...
            if(item.endWork != "NULL"){
                return(
                    ...
                    <tr>
                        ...
                        <td >
                            <input className="control-input" type="checkbox" checked={0} id="id_stillWorking"name="id_stillWorking"   />
                        </td>
                    </tr>
                    <tr>
                ...
                return(
                    ...
                    <tr>
                        <td> <label className="control-label" for="id_endWork">Конец работы:</label></td>
                        <td className="col-sm-8">
                            <input type="date" className="form-control" value={null}  id="id_endWork" name="id_endWork" />
                        </td>
                    </tr>
                    <tr>
                        <td> <label className="control-label" for="id_stillWorking">Еще работаю:</label></td>
