                    ...
                    <div className="container-sm main-container">
                        <div className="row container-t">
                            ...
                            <div className="col col-4" id="left-container-t1">
                                ...
                                <div className="col text-capitalize icon-text"><img className="icon-item" src={location} alt="location" />
                                    {this.state.userData.сityOfResidence}</div>
                                <div className="col icon-text"><img className="icon-item" src={phone} alt="phone" />
                                    {this.state.userData.phone}</div>
                                <div className="col long-text icon-text"><img className="icon-item" src={email} alt="email" />
                            ...
                            <div className="col" id="right-container">
                                        ...
                                        return (
                                            <div className="list-group-item" key={'val-' + i}>
                                                <div className="d-flex w-100 justify-content-between">
                                                    ...
                                                    <p className="mb-1 years">{value.startWork + " - " + value.endWork}</p>
                                                </div>
                                        ...
                                        return (
                                            <div className="list-group-item " key={'val-' + i}>
                                                <div className="d-flex w-100 justify-content-between">
                                                    ...
                                                    <p className="mb-1 years">{value.endingCourse}</p>
                                                </div>
                                ...
                                <div className="list-group ">
                                    <div className="list-group-item ">
                                        <div className="mb-1 long-text fz-14" >
